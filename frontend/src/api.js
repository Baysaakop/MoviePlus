const api = {
    ...
    ratings: 'http://127.0.0.1:8000/api/movies/ratings',
    genres: 'http://127.0.0.1:8000/api/movies/genres',
    productions: 'http://127.0.0.1:8000/api/movies/productions',
    occupations: 'http://127.0.0.1:8000/api/movies/occupations',
    artists: 'http://127.0.0.1:8000/api/movies/artists',
