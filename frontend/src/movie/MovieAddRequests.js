...
function MovieAddRequests (props) {
    ...
    function getMovies() {
        setLoading(true)
        var url = `${api.tempfilms}?filmid=0&page=${page}`          
        axios({
            method: 'GET',
            url: url
        }).then(res => {                                         
    ...
    return (
        <div style={{ marginTop: '80px', minHeight: '80vh' }}>
            <div style={{ padding: getPadding() }}>           
                <Typography.Title level={3}>Шинэ киноны хүсэлтүүд</Typography.Title>   
                { loading ? (
                                ...
                                <div>
                                    ...
                                    <Row gutter={[16, 16]}>
                                        ...
                                        <Col xs={24} sm={24} md={24} lg={12} style={{ textAlign: 'end' }}>
                                            ...
                                            <br />
                                            <Typography.Text>Он сар өдөр: {moment(item.movie.created_at).format("YYYY-MM-DD HH:mm:ss")}</Typography.Text>
                                        </Col>
                                    </Row>                                                                    
                                </div>
                            </List.Item>
...
export default connect(mapStateToProps)(MovieAddRequests)