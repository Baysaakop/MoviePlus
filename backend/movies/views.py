...
from .models import Genre, Rating, Production, Occupation, Score, Review, Member, Actor, Movie, Series
from .serializers import (
    GenreSerializer, RatingSerializer, ProductionSerializer, OccupationSerializer, 
    ScoreSerializer, ReviewSerializer, 
    MemberSerializer, ActorSerializer, MovieSerializer, SeriesSerializer
)
