        ...
        <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', height: '80vh', marginTop: '80px' }}>            
            {props.loading ? (
                ...
                <div style={{ border: '1px solid #8e44ad', borderRadius: '4px', padding: '16px', textAlign: 'center', width: '500px', margin: '16px' }}>
                    ...
                    {/* <Typography.Title level={3}>Монгол киноны нэгдсэн санд нэвтрэх</Typography.Title> */}
                    <Typography.Text style={{ fontSize: '16px' }}>Та өөрийн ашигладаг аль нэг сошиал хаягийг ашиглан MoviePlus-д нэвтрэх боломжтой.</Typography.Text>                    
                    <GoogleLogin                                                                                                            
                        clientId="296268545765-t0tu72rhuo4g2rpia6b8qirt08i6mea2.apps.googleusercontent.com"                        
                        render={renderProps => (
                            <Button size="large" danger type="primary" onClick={renderProps.onClick} icon={<GoogleOutlined style={{ fontSize: '24px' }} />} style={{ width: '100%', height: '80px', fontSize: '24px', margin: '16px 0' }}>
                    ...
                    <FacebookLogin
                        cssClass="login-facebook"
                        icon={<FacebookFilled />}
                        textButton=" Facebook хаягаар нэвтрэх"
                        appId="461902185229960"
                        fields="name,email"                                    
                        callback={(response) => authFacebook(response)}                                    
                    />                                
                </div>
            )}  
        </div>              
