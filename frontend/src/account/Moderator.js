...
function Moderator (props) {
    return (
        <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', minHeight: '40vh' }}>
            <Row gutter={[16, 16]}>
                <Col xs={24} sm={24} md={8} style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                ...
                <Col xs={24} sm={24} md={8} style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                    <Link to="/castrequests">
                        <Button size="large" type="ghost" style={{ width: '300px', height: '100px', fontSize: '20px' }}>Cast</Button>
                    </Link> 
                </Col>    
                <Col xs={24} sm={24} md={8} style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                    <Link to="/crewrequests">
                        <Button size="large" type="ghost" style={{ width: '300px', height: '100px', fontSize: '20px' }}>Crew</Button>
                    </Link> 
                </Col>             
            </Row>
        </div>
