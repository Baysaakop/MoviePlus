from .views import GenreViewSet, RatingViewSet, ProductionViewSet, OccupationViewSet, ScoreViewSet, CommentViewSet, ReviewViewSet, ArtistViewSet, MemberViewSet, ActorViewSet, MovieViewSet, SeriesViewSet
