import { Grid, Col, message, Row, Spin, Typography, Button, Tooltip, Breadcrumb } from 'antd';
            ...
            { artist ? (
                <div>
                    ...
                    <div style={{ padding: getPadding() }} className="detail">
                        <Row gutter={[16, 16]}>
                            <Col xs={24} sm={8} md={8} lg={8} xl={6} style={ screens.xs ? { padding: '0 8px' } : { padding: '8px 40px 0 8px'}}>
